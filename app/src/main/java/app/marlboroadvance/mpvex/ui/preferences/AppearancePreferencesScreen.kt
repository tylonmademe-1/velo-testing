                ...
                LazyColumn(
                    ...
                    item {
                        PreferenceCard {
                            ...
                            // 144Hz Refresh Rate toggle
                            val force144Hz by preferences.force144HzRefreshRate.collectAsState()
                            SwitchPreference(
                                value = force144Hz,
                                onValueChange = { newValue ->
                                    preferences.force144HzRefreshRate.set(newValue)
                                },
                                title = { Text(text = stringResource(id = R.string.pref_appearance_144hz_title)) },
                                summary = {
                                    Text(
                                        text = stringResource(id = R.string.pref_appearance_144hz_summary),
                                        color = MaterialTheme.colorScheme.outline,
                                    )
                                },
                            )
